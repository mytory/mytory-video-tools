...
再生速度の直接入力とファイルごとの速度保持、ツール別の出力ファイル名サフィックス、システムの表示モードへの追従を追加しました。保存に成功すると、現在の言語で支援カードを表示します。

---

## 1. 特徴

1. **サイドバータブナビゲーション**: 7つのコアメディアユーティリティをスタイリッシュなダークテーマのダッシュボード内で切り替えられます。
