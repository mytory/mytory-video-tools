...
const translations = {
    ...
    'Please choose an audio file that FFmpeg can read.': {
        en: 'Please choose an audio file that FFmpeg can read.',
        ko: 'FFmpeg에서 읽을 수 있는 오디오 파일을 선택해 주세요.',
        ja: 'FFmpegで読み込める音声ファイルを選択してください。',
        'zh-cn': '请选择 FFmpeg 可以读取的音频文件。',
        es: 'Seleccione un archivo de audio que FFmpeg pueda leer.',
        pt: 'Selecione um arquivo de áudio que o FFmpeg possa ler.',
        fr: 'Sélectionnez un fichier audio lisible par FFmpeg.',
        id: 'Pilih file audio yang dapat dibaca FFmpeg.',
        hi: 'कृपया ऐसी ऑडियो फ़ाइल चुनें जिसे FFmpeg पढ़ सके।',
    },
    'Skipped Unsupported': {
    ...
    'file(s) skipped because no readable audio stream was found.': {
        en: 'file(s) skipped because no readable audio stream was found.',
        ko: '개 파일을 건너뛰었습니다 (읽을 수 있는 오디오 스트림이 없음).',
        ja: '件のファイルをスキップしました（読み取り可能な音声ストリームがありません）。',
        'zh-cn': '个文件已跳过（未找到可读取的音频流）。',
        es: 'archivo(s) omitido(s) porque no se encontró una secuencia de audio legible.',
        pt: 'arquivo(s) ignorado(s) porque não foi encontrado um fluxo de áudio legível.',
        fr: 'fichier(s) ignoré(s), car aucun flux audio lisible n’a été trouvé.',
        id: 'file dilewati karena tidak ditemukan aliran audio yang dapat dibaca.',
        hi: 'फ़ाइलें छोड़ी गईं क्योंकि पढ़ने योग्य ऑडियो स्ट्रीम नहीं मिली।',
    },
    // --- Frame Capture ---
    'Frame Saved': {
        en: 'Frame Saved',
