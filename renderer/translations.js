...
const translations = {
    ...
    'Audio Compressor': {
        ...
        ja: '音声圧縮',
        'zh-cn': '音频压缩',
        es: 'Compresor de audio',
        pt: 'Compressor de áudio',
        fr: 'Compresseur audio',
        id: 'Kompresor audio',
        hi: 'ऑडियो संपीडक',
    },
    'Audio Compressed': {
        ...
        fr: 'Audio compressé',
        id: 'Audio dikompresi',
        hi: 'ऑडियो संपीड़ित किया गया',
    },
    'Audio Compression Failed': {
        en: 'Audio Compression Failed',
        ko: '오디오 압축 실패',
        ja: '音声圧縮失敗',
        'zh-cn': '音频压缩失败',
        es: 'Compresión de audio fallida',
        pt: 'Compressão de áudio falhou',
        fr: 'Compression audio échouée',
        id: 'Kompresi audio gagal',
        hi: 'ऑडियो संपीड़न विफल',
    },
    'Unsupported Format': {
        ...
        pt: 'Formato não compatível',
        fr: 'Format non pris en charge',
        id: 'Format tidak didukung',
        hi: 'असमर्थित प्रारूप',
    },
    'Please use lossless audio files (WAV, AIFF, FLAC, ALAC, M4A).': {
        en: 'Please use lossless audio files (WAV, AIFF, FLAC, ALAC, M4A).',
        ko: '무손실 오디오 파일(WAV, AIFF, FLAC, ALAC, M4A)만 지원합니다.',
        ja: 'ロスレス音声ファイル（WAV、AIFF、FLAC、ALAC、M4A）のみ対応しています。',
        'zh-cn': '仅支持无损音频文件（WAV、AIFF、FLAC、ALAC、M4A）。',
        es: 'Solo se admiten archivos de audio sin pérdidas (WAV, AIFF, FLAC, ALAC, M4A).',
        pt: 'Apenas arquivos de áudio sem perdas (WAV, AIFF, FLAC, ALAC, M4A) são compatíveis.',
        fr: 'Seuls les fichiers audio sans perte (WAV, AIFF, FLAC, ALAC, M4A) sont pris en charge.',
        id: 'Hanya file audio lossless (WAV, AIFF, FLAC, ALAC, M4A) yang didukung.',
        hi: 'केवल लॉसलेस ऑडियो फ़ाइलें (WAV, AIFF, FLAC, ALAC, M4A) समर्थित हैं।',
    },
    'Skipped Unsupported': {
        en: 'Skipped Unsupported',
        ko: '지원하지 않는 파일 건너뜀',
        ja: 'サポート外のファイルをスキップ',
        'zh-cn': '已跳过不支持的格式',
        es: 'Omitido no compatible',
        pt: 'Pulado não compatível',
        fr: 'Ignoré (non pris en charge)',
        id: 'Dilewati (tidak didukung)',
        hi: 'असमर्थित छोड़ दिया गया',
    },
    'file(s) skipped (only lossless formats supported).': {
        en: 'file(s) skipped (only lossless formats supported).',
        ko: '개 파일이 건너뛰어졌습니다 (무손실 포맷만 지원).',
        ja: 'ファイルをスキップしました（ロスレス形式のみ対応）。',
        'zh-cn': '个文件被跳过（仅支持无损格式）。',
        es: 'archivo(s) omitido(s) (solo se admiten formatos sin pérdidas).',
        pt: 'arquivo(s) pulado(s) (apenas formatos sem perdas são compatíveis).',
        fr: 'fichier(s) ignoré(s) (seuls les formats sans perte sont pris en charge).',
        id: 'file dilewati (hanya format lossless yang didukung).',
        hi: 'फ़ाइल(ें) छोड़ी गईं (केवल लॉसलेस प्रारूप समर्थित)।',
    },
    // --- Frame Capture ---
    'Frame Saved': {
        en: 'Frame Saved',
...
const templateTranslations = {
    ...
    '!audio_compressed_saved': {
        en: (name) => `${name} compressed to MP3!`,
        ko: (name) => `${name} MP3 압축 완료!`,
        ja: (name) => `${name} MP3圧縮完了!`,
        'zh-cn': (name) => `${name} MP3压缩完成!`,
        es: (name) => `${name} comprimido a MP3!`,
        pt: (name) => `${name} comprimido para MP3!`,
        fr: (name) => `${name} compressé en MP3!`,
        id: (name) => `${name} dikompresi ke MP3!`,
        hi: (name) => `${name} MP3 में संपीड़ित किया गया!`,
    },
    '!audio_file_saved': {
