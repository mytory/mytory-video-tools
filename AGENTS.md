...
커밋을 너무 자주 하지 않습니다. 논리적 작업 단위로 커밋합니다.

푸시는 적당한 순간에 합니다. 단, 강제 푸시는 사용자만 할 수 있습니다.
...
사용자가 계획을 짜라고 지시했다면 절대 곧장 코드 수정으로 넘어가지 않고 계획을 사용자에게 검토받습니다.

사용자가 계획짜고 바로 코드도 짜라고 했다면 그대로 따릅니다.

별도 지시가 없다면 자체 판단합니다.

가능하고 바람직한 경우 계획은 자신이 세우고 구현은 더 비용효율적인 서브 에이전트에게 시킵니다.
